...
function addOrganization(id_value) {
    document.getElementById(`new-org-block-${id_value}`).outerHTML =
        `<div id="org-block-${id_value}" class="org-block">
            <div class="org-name-url">
                <div class="org-row">
                    <p>Company name</p>
                     <input id="org-name-DEFAULT-${id_value}-ORG" class="DEFAULT-${id_value}-ORG" type="text" name="${id_value}" value=""
            ...
            <div id="positions-DEFAULT-${id_value}-ORG">
                <div id="end-DEFAULT-${id_value}-ORG"></div>
            </div>
            <div class="buttons">
                <input type="button" value="Add position" class="inner-button btn-DEFAULT-${id_value}-ORG" name="DEFAULT-${id_value}-ORG"
                    onclick="addPosition(this.name)">
                <input type="button" value="Remove positions" class="inner-button btn-DEFAULT-${id_value}-ORG" name="DEFAULT-${id_value}-ORG"
                    onclick="clearPositions(this.name)">
            </div>
        </div>
        <div id="new-org-block-${id_value}"></div>`;
}
